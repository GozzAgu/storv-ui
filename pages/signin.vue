          ...
          <form @submit.prevent="handleSignIn" class="space-y-4">
            <div class="space-y-1.5">
              ...
              <input
                ...
                autocomplete="email"
                required
                class="w-full rounded-sm border border-gray-200 bg-white px-3 py-2.5 text-xs text-gray-900 placeholder-gray-400 outline-none transition duration-200 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/25 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 dark:placeholder-gray-500"
            ...
            <div class="space-y-1.5">
              ...
              <div class="relative">
                <input
                  ...
                  required
                  class="w-full rounded-sm border border-gray-200 bg-white px-3 py-2.5 pr-10 text-xs text-gray-900 placeholder-gray-400 outline-none transition duration-200 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/25 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 dark:placeholder-gray-500"
