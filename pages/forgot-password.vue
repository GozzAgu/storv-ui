<template>
 ...
 <div
 class="overflow-hidden rounded-sm bg-white dark:border-gray-800 dark:bg-slate-950"
 >
 ...
 autocomplete="email"
 required
 class="w-full rounded-sm bg-white px-3 py-2 text-xs text-gray-900 placeholder-gray-400 outline-none transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500/25 dark:bg-gray-800 dark:text-gray-100 dark:placeholder-gray-500"
