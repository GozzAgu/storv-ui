    ...
    <div class="pt-24 pb-16 sm:pt-32 sm:pb-24">
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="prose prose-lg max-w-none">
          <h1 class="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">Terms of Service</h1>
          ...
          <div class="space-y-8 text-gray-700">
            ...
            <section>
              ...
              <h3 class="text-xl font-semibold text-gray-900 mt-6 mb-3">5.2 Billing</h3>
              <p class="mb-4">
              ...
              <h3 class="text-xl font-semibold text-gray-900 mt-6 mb-3">5.3 Cancellation</h3>
              <p class="mb-4">
              ...
              <h3 class="text-xl font-semibold text-gray-900 mt-6 mb-3">5.4 Refunds</h3>
              <p class="mb-4">
            ...
            <section>
              ...
              <h3 class="text-xl font-semibold text-gray-900 mt-6 mb-3">7.2 Responsibility</h3>
              <p class="mb-4">
