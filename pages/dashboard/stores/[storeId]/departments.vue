<template>
    ...
    <div v-else-if="!departmentsStore.error" class="space-y-6">
      ...
      <div
        ...
        class="rounded-lg bg-gray-50 dark:bg-gray-800 flex flex-col items-center justify-center py-10 px-4 text-center min-h-[calc(100svh-12rem)] sm:min-h-[calc(100svh-10rem)]"
      >
