<template>
  <div class="pb-24 sm:pb-20 min-h-screen w-full overflow-x-hidden">
      ...
      <div class="rounded-2xl bg-gray-50 dark:bg-gray-800/80 overflow-hidden min-h-[280px] ring-1 ring-gray-200/50 dark:ring-gray-700/50">
        ...
        <div class="p-4 sm:p-6">
          <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            <div v-for="i in 6" :key="i" class="rounded-xl bg-white dark:bg-gray-800/60 ring-1 ring-gray-200/50 overflow-hidden">
    ...
    <div v-else-if="!departmentsStore.error" class="space-y-6">
      ...
      <div v-if="paginatedDepartments.length > 0" class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 gap-4">
        <div
        ...
        >
          <div class="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-700/50">
            <div class="flex items-center gap-3 flex-1 min-w-0">
              ...
              <h3 class="text-sm font-semibold text-gray-900 dark:text-gray-100 truncate group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">{{ department.name }}</h3>
            </div>
