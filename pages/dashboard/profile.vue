<template>
 ...
 :class="[ 'w-full p-4 rounded-sm border-0 transition-all text-left', currentThemeValue === themeOption.value ? 'bg-primary-50 dark:bg-primary-900/20' : 'bg-gray-50/80 dark:bg-gray-800/50' ]"
 >
 ...
 :class="[ 'w-full p-4 rounded-sm border-0 transition-all text-left', accountSettings.language === lang.name ? 'bg-primary-50 dark:bg-primary-900/20' : 'bg-gray-50/80 dark:bg-gray-800/50' ]"
 >
 <div class="flex items-center justify-between">
 <div>
 ...
 :class="[ 'w-full p-4 rounded-sm border-0 transition-all text-left', accountSettings.region === region.name ? 'bg-primary-50 dark:bg-primary-900/20' : 'bg-gray-50/80 dark:bg-gray-800/50' ]"
 >
 <div class="flex items-center justify-between">
 ...
 :class="[ 'w-full p-4 rounded-sm border-0 transition-all text-left', accountSettings.currency === currency.code ? 'bg-primary-50 dark:bg-primary-900/20' : 'bg-gray-50/80 dark:bg-gray-800/50' ]"
 >
 <div class="flex items-center justify-between">
 <div>
