<template>
 ...
 :class="[headerBtnClass, 'gap-1.5-gray-200/90 !bg-white !font-medium !text-gray-800 hover:!bg-gray-50 dark:!border-gray-700/80 dark:!bg-dashboard-card dark:!text-gray-100']"
 ...
 type="button"
 :disabled="isExporting"
 :class="[headerBtnClass, 'gap-1.5-emerald-200/90 !bg-emerald-50/90 !font-medium !text-emerald-800 hover:!bg-emerald-100/90 dark:!border-emerald-800/60 dark:!bg-emerald-950/40 dark:!text-emerald-300']"
