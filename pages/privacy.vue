          ...
          <div class="space-y-8 text-gray-700">
            ...
            <section>
              ...
              <ul class="list-disc pl-6 mb-4 space-y-2">
                ...
                <li>Inventory data (products, stock levels, transactions)</li>
            ...
            <section>
              <h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">6. Your Rights and Choices</h2>
              ...
              <p class="mb-4">
                To exercise these rights, please contact us at privacy@storv.com
              </p>
            </section>

            <section>
              <h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">7. Cookies and Tracking Technologies</h2>
              <p class="mb-4">
            ...
            <section>
              <h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">8. Data Retention</h2>
              <p class="mb-4">
            ...
            <section>
              <h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">10. International Data Transfers</h2>
              <p class="mb-4">
            ...
            <section>
              <h2 class="text-2xl font-bold text-gray-900 mt-8 mb-4">11. Changes to This Privacy Policy</h2>
              <p class="mb-4">
