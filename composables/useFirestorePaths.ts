 ...
 */
export function getStoreDocument(
  db: Firestore,
  userId: string,
  storeId: string
): DocumentReference {
 ...
 */
export function getDepartmentsCollection(
  db: Firestore,
  userId: string,
  storeId: string
): CollectionReference {
 ...
 */
export function getDepartmentDocument(
  db: Firestore,
  userId: string,
  storeId: string,
  departmentId: string
 ...
 */
export function getStaffCollection(
  db: Firestore,
  userId: string,
  storeId: string,
  departmentId: string
 ...
 */
export function getStaffDocument(
  db: Firestore,
  userId: string,
  storeId: string,
  departmentId: string,
 ...
 */
export function getInventoryFoldersCollection(
  db: Firestore,
  userId: string,
  storeId: string
): CollectionReference {
 ...
 */
export function getInventoryFolderDocument(
  db: Firestore,
  userId: string,
  storeId: string,
  folderId: string
 ...
 */
export function getInventoryItemsCollection(
  db: Firestore,
  userId: string,
  storeId: string
): CollectionReference {
 ...
 */
export function getInventoryItemDocument(
  db: Firestore,
  userId: string,
  storeId: string,
  itemId: string
 ...
 */
export function getSellerLoanOutsCollection(
  db: Firestore,
  userId: string,
  storeId: string
): CollectionReference {
...
export function getSellerLoanOutDocument(
  db: Firestore,
  userId: string,
  storeId: string,
  loanId: string
 ...
 */
export function getCustomerDocument(
  db: Firestore,
  userId: string,
  storeId: string,
  customerId: string
 ...
 */
export function getCustomerAccountsCollection(
  db: Firestore,
  userId: string,
  storeId: string
): CollectionReference {
 ...
 */
export function getNotificationDocument(
  db: Firestore,
  userId: string,
  storeId: string,
...
export async function getQueryUserId(): Promise<string | null> {
  ...
  if (userStore.userData?.role === 'staff') {
    ...
    if (db) {
        ...
        if (!isFetching) {
          try {
            ...
            if (
              ...
              console.error(
                '[useFirestorePaths] Permission denied when fetching staff member. Check Firestore rules allow staff to query collections.'
              )
            }
          }
        } else {
      ...
      if (userStore.userData?.role === 'staff') {
        console.error(
          '[useFirestorePaths] Staff member not found in legacy collection or cache. This will prevent data from loading.'
        )
