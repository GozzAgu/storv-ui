...
export function useDashboardOverlayChrome() {
  ...
  const bodyClass =
    'min-h-0 flex-1 overflow-y-auto overflow-x-hidden overscroll-contain bg-white dark:!bg-dashboard-card'
  ...
  const eyebrowClass =
    'text-[10px] font-semibold uppercase tracking-[0.16em] text-gray-400 dark:text-gray-500'
