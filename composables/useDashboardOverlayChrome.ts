...
export function useDashboardOverlayChrome() {
  ...
  const shellClass =
    'flex min-h-0 w-full flex-col overflow-hidden border border-gray-200/90 bg-white pb-[env(safe-area-inset-bottom,0)] text-gray-900 shadow-2xl shadow-gray-900/10 dark:border-gray-800/90 dark:!bg-dashboard-card dark:text-gray-100 dark:shadow-black/40'
