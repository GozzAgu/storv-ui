...
export const APP_FIELD_BORDER_CLASS =
  'border border-solid border-primary-500/10 transition-[border-color,box-shadow,background-color] duration-200 ease-out focus:border-gray-400/40 dark:border-primary-300/12 dark:focus:border-white/30'
...
const APP_FIELD_BASE = [
  ...
  'min-h-9 h-9 py-0',
  'placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400/15',
  'dark:bg-white/[0.04] dark:text-gray-100 dark:placeholder:text-gray-500 dark:focus:ring-white/10',
].join(' ')
...
export const APP_FIELD_COMPACT_CLASS = [
  ...
  'placeholder:font-normal placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400/15',
  'dark:bg-white/[0.04] dark:text-gray-200 dark:placeholder:text-gray-500 dark:focus:ring-white/10',
].join(' ')
