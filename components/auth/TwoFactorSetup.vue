<template>
 ...
 :class="[ 'p-4 rounded-sm border-0 transition-all text-left', selectedMethod === 'totp' ? 'bg-primary-50 dark:bg-primary-900/20' : 'bg-gray-50/80 dark:bg-gray-800/50' ]"
 >
 ...
 :class="[ 'p-4 rounded-sm border-0 transition-all text-left', selectedMethod === 'phone' ? 'bg-primary-50 dark:bg-primary-900/20' : 'bg-gray-50/80 dark:bg-gray-800/50' ]"
 >
 <div class="flex items-center gap-2 mb-1.5">
 ...
 <code class="flex-1 px-3 py-1.5 bg-white dark:!bg-dashboard-card rounded-sm text-xs sm:text-sm font-mono text-gray-900 dark:text-gray-100 break-all">
 {{ secretKey }}
 </code>
 <button
 @click="copySecret"
 ...
 <div class="bg-gray-50 dark:bg-gray-800/50 rounded-sm p-3 border border-dashed border-gray-300">
