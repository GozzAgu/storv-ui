...
<template>
  ...
  <div
    ...
    class="dashboard-inline-footer mt-4 w-full shrink-0 border-t border-gray-200/80 bg-gray-50/90 px-3 py-2 dark:border-gray-700/80 dark:bg-white/[0.03] sm:px-5 sm:py-2.5"
  >
    <div
  ...
  <Teleport v-else to="body">
    <div
      role="region"
      aria-label="Table pagination"
      class="dashboard-fixed-footer pointer-events-auto fixed bottom-0 left-0 right-0 z-50 min-w-0 border-t border-gray-200/80 bg-gray-50/90 backdrop-blur-sm transition-[left] duration-300 dark:border-gray-700/80 dark:bg-[#07080c]/95 dark:backdrop-blur-sm"
      :class="[
