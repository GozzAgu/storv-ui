...
<template>
  ...
  >
    <div
      class="relative inline-flex max-w-[min(18rem,calc(100vw-4rem))] flex-col items-start gap-0 rounded-sm border border-gray-700/40 bg-gray-900 px-2.5 py-1.5 text-left text-xs font-medium leading-snug text-white shadow-md dark:border-gray-700/50 dark:bg-gray-950"
    >
      <slot />
      <div
