...
const variantSurfaceClasses = computed(() => {
  const map = {
    ...
    secondary:
      'bg-white text-gray-900 ring-1 ring-inset ring-gray-200/90 hover:bg-gray-50 dark:bg-gray-800/90 dark:text-gray-50 dark:ring-gray-600/80 dark:hover:bg-gray-800',
    danger:
      'bg-red-600 text-white shadow-sm hover:bg-red-700 active:bg-red-800',
    success:
      'bg-emerald-600 text-white shadow-sm hover:bg-emerald-700 active:bg-emerald-800',
    outline:
      'bg-white text-gray-800 ring-1 ring-inset ring-gray-200/90 hover:bg-gray-50 dark:bg-gray-900/40 dark:text-gray-100 dark:ring-gray-600/80 dark:hover:bg-gray-800/60',
    ghost:
