...
const variantClasses = computed(() => {
  const variantMap = {
    primary: 'bg-gradient-to-r from-primary-500 to-purple-600 hover:from-primary-600 hover:to-purple-700 text-white shadow-sm hover:shadow-md focus:ring-primary-500 dark:focus:ring-offset-gray-800',
