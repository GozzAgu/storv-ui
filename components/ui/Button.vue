<template>
  <button
    ...
    :class="[
      'inline-flex items-center justify-center gap-1.5 sm:gap-2 font-medium rounded-md transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed',
      sizeClasses,
      variantClasses,
      extraClass
    ]"
