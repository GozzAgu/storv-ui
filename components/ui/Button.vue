<template>
  <button
    ...
    :class="[ 'relative inline-flex items-center justify-center rounded-md border-0 font-semibold cursor-pointer transition duration-200 ease-out focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed', sizeClasses, variantBgClasses, variantFocusRingClasses, variantTextClasses, extraClass ]"
    @click="handleClick"
  >
