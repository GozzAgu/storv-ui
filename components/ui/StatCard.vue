<template>
  <div
    class="group relative overflow-hidden rounded-xl bg-white/85 backdrop-blur-md transition duration-300 dark:bg-dashboard-card/88 dark:backdrop-blur-xl"
  >
    <!-- Specular highlight -->
    <span
    ...
    <div class="relative p-2.5 sm:p-3 md:p-3.5">
      ...
      <div class="mt-1.5 flex min-w-0 items-baseline justify-between gap-1.5 sm:gap-2">
        ...
        <span
          ...
          :class="[
            'shrink-0 rounded-full px-1 py-0.5 text-[9px] font-semibold tabular-nums sm:px-2 sm:py-0.5 sm:text-[10px] md:text-[11px]',
            changePositive === true
              ...
              : 'bg-gray-100/90 text-gray-600 dark:bg-white/[0.06] dark:text-gray-400',
          ]"
        >
          {{ change }}
        </span>
      ...
      <p
        ...
        :class="[
          'mt-1 text-[9px] leading-relaxed sm:text-[10px] md:text-[11px]',
