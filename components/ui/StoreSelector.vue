<template>
  <div class="relative min-w-0 shrink" ref="dropdownRef">
    ...
    >
      <span
        ...
        :class="
          currentStore
            ...
            : 'bg-gray-100 /90 dark:bg-white/8 dark:ring-white/8'
        "
      ...
      >
        <svg
          class="h-3.5 w-3.5 animate-spin text-gray-500 dark:text-gray-400"
          fill="none"
          viewBox="0 0 24 24"
        >
          <circle
    ...
    >
      ...
      >
        <div
          class="store-switch-panel__surface relative flex max-h-full min-h-0 flex-col overflow-hidden rounded-xl bg-white py-1 shadow-md shadow-zinc-900/8 ring-1 ring-black/5 dark:bg-zinc-900 dark:shadow-lg dark:shadow-black/45 dark:ring-white/8"
        >
          ...
          >
            ...
            <div
              ...
              class="px-2 py-3 text-center text-xs text-zinc-500 dark:text-zinc-400"
            >
              No stores available
            </div>
