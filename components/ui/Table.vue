      ...
      <thead v-if="columns && columns.length > 0" class="border-b border-gray-200/90 bg-gray-50/95 dark:border-gray-800/80 dark:!bg-dashboard-card/90">
        <tr>
          <th
            ...
            :key="column.key"
            :class="[ 'whitespace-nowrap bg-gray-50/95 px-3 py-2.5 text-left text-[11px] !font-semibold text-gray-600 dark:!bg-dashboard-card/90 dark:text-gray-400 uppercase tracking-wide', column.sortable ? 'cursor-pointer hover:bg-gray-100 dark:hover:bg-white/5 select-none' : '', column.class || '', headerClass ]"
          ...
          <th
            v-if="showActions"
            class="whitespace-nowrap bg-gray-50/95 px-3 py-2.5 text-right text-[11px] !font-semibold text-gray-600 dark:!bg-dashboard-card/90 dark:text-gray-400 uppercase tracking-wide"
          >
            Actions
          </th>
        </tr>
