      ...
      <div v-else class="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            class="w-full rounded-sm border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-1 focus:ring-primary-400 dark:border-gray-600 dark:!bg-dashboard-card dark:text-gray-100"
          />
          <p v-if="contactInput && !contactValid" class="mt-1 text-[11px] text-amber-600 dark:text-amber-400">
...
import { captureReceiptElementAsPng, captureReceiptElementAsPdf } from '~/composables/useReceiptImageCapture'
