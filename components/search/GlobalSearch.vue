        ...
        <div class="p-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <div class="flex items-center gap-2 mt-3 flex-wrap">
            ...
            <button
              ...
              class="px-3 py-1.5 text-xs font-medium rounded-lg bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 hover:bg-red-200 dark:hover:bg-red-900/50 transition-colors"
            >
              Clear Filters
            </button>
          </div>
            ...
            <div class="grid grid-cols-2 gap-3">
              <div>
                ...
                <input
                  v-model="startDate"
                  type="date"
                  class="w-full px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500"
          ...
          <div v-else-if="!searchStore.query.trim() && !searchStore.hasActiveFilters" class="p-8">
            ...
            <div v-if="savedSearches.length > 0" class="space-y-2">
              ...
              <button
                ...
                class="w-full px-3 py-2 text-left text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors flex items-center justify-between group"
              >
...
const getEntityTypeBadgeColor = (type: SearchEntityType) => {
  const colors: Record<string, string> = {
    ...
    customers: 'bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300',
