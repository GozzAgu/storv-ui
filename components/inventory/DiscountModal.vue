<template>
 ...
 @click="discountType = 'percentage'"
              :class="[ 'py-2.5 px-3 rounded-sm border-0 text-left transition-all duration-200', discountType === 'percentage' ? 'bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-300' : 'bg-gray-50/80 text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50' ]"
 >
 ...
 @click="discountType = 'amount'"
              :class="[ 'py-2.5 px-3 rounded-sm border-0 text-left transition-all duration-200', discountType === 'amount' ? 'bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-300' : 'bg-gray-50/80 text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800/50' ]"
 >
