<template>
 ...
 <div class="flex-1 flex items-center gap-2 px-3 py-2.5 rounded-sm bg-gray-50 dark:!bg-dashboard-card/90/80">
 ...
 <Button size="sm" class="!rounded-2xl w-full sm:w-auto min-w-[120px]" @click="closeAfterSuccess">
 Done
 </Button>
 </div>
 ...
 <Button variant="outline" size="sm" @click="handleClose" class="w-full sm:w-auto !rounded-2xl">Cancel</Button>
 <Button size="sm" @click="handleSubmit" :disabled="isSubmitting || !isFormValid" class="w-full sm:w-auto !rounded-2xl">
