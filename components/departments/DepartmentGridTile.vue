<template>
  <div
    class="dept-grid-tile group relative flex h-full min-h-[78px] w-full cursor-pointer flex-col overflow-hidden rounded-xl bg-white/95 shadow-none backdrop-blur-sm transition-[transform,background-color] duration-300 ease-out hover:bg-white active:scale-[0.98] dark:bg-white/[0.04] dark:shadow-[inset_0_1px_0_rgb(255_255_255/0.05)] sm:min-h-[82px]"
