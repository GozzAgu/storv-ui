<template>
  <article
    class="dept-grid-card app-card group relative flex w-full flex-col rounded-xl border-0 bg-white p-2.5 shadow-[0_1px_2px_rgb(0_0_0/0.04)] transition-colors duration-200 dark:bg-[#141820] dark:shadow-none"
    :class="[
      inactive
        ? 'cursor-not-allowed opacity-60'
        : 'cursor-pointer hover:bg-gray-50/80 dark:hover:bg-white/[0.04]',
    ...
    <div class="mt-2 border-t border-gray-100/90 pt-2 dark:border-white/[0.06]">
      <div class="flex items-center gap-1.5">
        ...
        >
          ...
          <span
            class="absolute text-[8px] font-semibold tabular-nums text-gray-700 dark:text-gray-200"
          >
            {{ staffCount }}
          </span>
        </div>
