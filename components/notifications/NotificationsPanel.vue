<template>
 <div
 :class="[ 'rounded-sm bg-white shadow-[0_12px_30px_-18px_rgba(15,23,42,0.3)] dark:bg-dashboard-card dark:shadow-[0_12px_28px_-16px_rgba(0,0,0,0.55)] overflow-hidden flex flex-col', variant === 'dropdown' ? 'max-h-[min(85vh,24rem)] w-full min-w-[18rem]' : '' ]"
 >
 <!-- Header: title + Mark all as read -->
 <div class="flex items-center justify-between px-3.5 pt-3 pb-2 border-b border-gray-100 shrink-0 bg-gray-50/60 dark:bg-white/[0.02]">
 ...
 <div class="flex items-center gap-0.5 border-b border-gray-100 px-3.5 shrink-0 bg-white/70 dark:bg-dashboard-card">
 <button
 type="button"
