        ...
        <div>
          ...
          <div class="mt-2 flex flex-wrap gap-2">
            <button
              ...
              :key="preset.label"
              type="button"
              class="rounded-sm border border-gray-200 px-2 py-1 text-[11px] font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800"
