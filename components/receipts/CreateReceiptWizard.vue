<template>
 ...
 <div class="h-5 w-5 animate-spin rounded-full border-0 border-primary-500/30 border-t-primary-500" />
 ...
 <p class="text-[10px] text-gray-500 dark:text-gray-400 tabular-nums pt-1 border-t border-gray-200/80/60">
 ...
 rows="2"
 class="w-full px-3 py-2 text-xs rounded-sm bg-white dark:!bg-dashboard-card text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-1 focus:ring-primary-400/60 resize-none"
 ...
 required
 class="w-full px-3 py-2 text-xs rounded-sm bg-white dark:!bg-dashboard-card text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-1 focus:ring-primary-400/50"
 >
