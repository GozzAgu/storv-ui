  ...
  >
    <template #header>
      <div class="flex items-center gap-3">
        <div class="w-10 h-10 rounded-sm bg-red-100 dark:bg-red-900/30 flex items-center justify-center">
    ...
    <div v-else class="max-h-[calc(100vh-16rem)] overflow-y-auto space-y-4">
      <!-- Warning Message -->
      <div class="p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-sm">
      ...
      <div class="space-y-3">
            ...
            <div class="overflow-x-auto max-h-48 overflow-y-auto">
              <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="sticky top-0 bg-gray-50/95 dark:!bg-dashboard-card/90">
                  <tr>
                    <th class="bg-gray-50/95 px-4 py-3 text-left text-xs !font-bold text-gray-500 dark:!bg-dashboard-card/90 dark:text-gray-400 uppercase">Product</th>
                    <th class="bg-gray-50/95 px-4 py-3 text-center text-xs !font-bold text-gray-500 dark:!bg-dashboard-card/90 dark:text-gray-400 uppercase">Quantity</th>
                    <th class="bg-gray-50/95 px-4 py-3 text-right text-xs !font-bold text-gray-500 dark:!bg-dashboard-card/90 dark:text-gray-400 uppercase">Price</th>
                    <th class="bg-gray-50/95 px-4 py-3 text-right text-xs !font-bold text-gray-500 dark:!bg-dashboard-card/90 dark:text-gray-400 uppercase">Total</th>
                  </tr>
                </thead>
        ...
        <!-- What Will Happen -->
        <div class="p-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-sm">
