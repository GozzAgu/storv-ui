            ...
            <div class="overflow-x-auto max-h-48 overflow-y-auto">
              <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="sticky top-0 bg-gray-50/95 dark:!bg-dashboard-card/90">
                  <tr>
                    <th class="px-4 py-3 text-left text-xs !font-bold text-gray-500 dark:text-gray-400 uppercase">Product</th>
                    <th class="px-4 py-3 text-center text-xs !font-bold text-gray-500 dark:text-gray-400 uppercase">Quantity</th>
                    <th class="px-4 py-3 text-right text-xs !font-bold text-gray-500 dark:text-gray-400 uppercase">Price</th>
                    <th class="px-4 py-3 text-right text-xs !font-bold text-gray-500 dark:text-gray-400 uppercase">Total</th>
                  </tr>
                </thead>
